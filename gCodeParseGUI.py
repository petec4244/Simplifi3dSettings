...
#Set this true to use hard coded files by default, and display some otherwise hidden info
DEBUGIN = False
...
tabSwitchNum = {10:'Info', 26:'Extruder', 41:'Layer', 65:'Additions', 75:'Infill', 89:'Support', 98:'Temperature', 109:'Cooling',
				138:'GCode', 150:'Scripts', 163:'Other', 185:'Advanced' #advanced should really end at 184
				#, 185:'LAST'  # the last entry really should appear on the 'Other tab' but out of laziness im going to add it to the Advanced tab and make a note.
				}
...
def mainRead(File1, File2, outFile, note):
	...
	if DEBUGIN:
		File1 = os.environ["USERPROFILE"] +r"\Documents\Python\HandOfThe_King.gcode"
		File2 = os.environ["USERPROFILE"] +r"\Documents\Python\HandOfThe_King2.gcode"
...
if __name__ == "__main__":
	...
	Button(fr12, text="Compare The Files", command=(lambda: mainRead(File1, File2, outFile, note))).grid(column=1, row=4, sticky=(W))
	Button(fr12, text="Close", command=(lambda: sys.exit())).grid(column=1, row=8, sticky=(W, E))
